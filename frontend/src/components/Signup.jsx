...
import { Sparkles, Mail, Lock, UserPlus, ShieldCheck, AlertCircle, User } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#0F172A] flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-mentor-purple/10 rounded-full blur-[120px]"></div>
        <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-mentor-blue/10 rounded-full blur-[120px]"></div>
      </div>
      ...
      <div className="w-full max-w-md relative">
        <div className="bg-[#1E293B]/60 backdrop-blur-xl border border-mentor-border p-6 sm:p-8 rounded-3xl shadow-2xl">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-mentor-textMuted">Start your AI-powered learning journey</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <label className="text-sm font-medium text-mentor-textMuted ml-1">Full Name</label>
              <div className="relative group">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-mentor-textMuted group-focus-within:text-mentor-purple transition-colors" />
                <input
                  type="text"
                  value={name}
          ...
          <p className="mt-8 text-center text-mentor-textMuted">
            ...
            <Link to="/login" className="text-mentor-purple hover:text-mentor-purple/80 font-semibold underline-offset-4 hover:underline transition-all">
              Sign in instead
            </Link>
          </p>
        </div>
